...
public class CertVerifyRequestValidator implements IRequestValidator {
    ...
    private void validateId() throws BaseException {
        ...
        if(StringUtils.isBlank(id) && error){
            throw new BaseException(IResponseMessage.INVALID_REQUESTED_DATA, MessageFormat.format(IResponseMessage.MISSING_MANADATORY_PARAMS,JsonKeys.DATA), ResponseCode.CLIENT_ERROR.getCode());
        }}
}

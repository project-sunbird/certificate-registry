...
import org.sunbird.cassandra.common.CassandraUtil;
import org.sunbird.cassandra.common.Constants;
import org.sunbird.cassandra.helper.CassandraConnectionManager;
import org.sunbird.cassandra.helper.CassandraConnectionMngrFactory;
...
public abstract class CassandraOperationImpl implements CassandraOperation {
 ...
 static Logger logger = Logger.getLogger(CassandraOperationImpl.class);

  public CassandraOperationImpl() {
    PropertiesCache propertiesCache = PropertiesCache.getInstance();
    String cassandraMode = propertiesCache.getProperty(Constants.SUNBIRD_CASSANDRA_MODE);
  ...
  public Response insertRecord(String keyspaceName, String tableName, Map<String, Object> request) throws BaseException {
    ...
    try {
      ...
      logger.error(
          "Exception occured while inserting record to " + tableName + " : " + e.getMessage(), e);
      throw new BaseException(
          IResponseMessage.DB_INSERTION_FAIL_KEY,
              IResponseMessage.DB_INSERTION_FAIL_MSG,
  ...
  public Response updateRecord(
    ...
    try {
      ...
      throw new BaseException(
              IResponseMessage.DB_UPDATE_FAIL_KEY,
              IResponseMessage.DB_UPDATE_FAIL_MSG,
          ResponseCode.SERVER_ERROR.getCode());
    }
    logQueryElapseTime("updateRecord", startTime);
    return response;

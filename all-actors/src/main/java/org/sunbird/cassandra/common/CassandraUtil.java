package org.sunbird.cassandra.common;
...
import org.sunbird.cassandra.cassandraannotation.ClusteringKey;
import org.sunbird.cassandra.cassandraannotation.PartitioningKey;
import org.sunbird.cassandra.helper.CassandraConnectionManagerImpl;
...
public final class CassandraUtil {
  ...
  public static String processExceptionForUnknownIdentifier(Exception e) {
    ...
    return MessageFormat.format(
            IResponseMessage.INVALID_PROPERTY_ERROR_MSG,
            e.getMessage()
